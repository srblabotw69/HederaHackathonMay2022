...
@WebServlet("/SmartContractServiceERC1400Servlet_createContract")
public class SmartContractServiceERC1400Servlet_createContract extends HttpServlet {
...
// 
			...
			smtContract.callSmartContractFunction_ERC1400v2_getDocument(AccountService.client, cid);
...
//        System.out.println("");
			...
			/////////////////////////////////////////////////////
			Object data =  "Creating contract with contractId of " + cid.toString();
...
//		request.setAttribute("accountInfo", accountInfo);
			...
			request.setAttribute("contractId", cid.toString());
