...
@WebServlet("/HelloContractServlet")
public class HelloContractServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("hedera/HelloContract.jsp").forward(request, response);
